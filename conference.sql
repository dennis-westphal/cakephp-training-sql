...
START TRANSACTION;
USE `cakephp`;
INSERT INTO `cakephp`.`users` (`id`, `username`, `password`, `type`, `name`, `surname`, `created`, `modified`) VALUES (1, 'dennis.westphal', 'password', 'author', 'Dennis', 'Westphal', '2017-05-14 17:11:00', '2017-05-14 17:11:00');
...
START TRANSACTION;
USE `cakephp`;
INSERT INTO `cakephp`.`topics` (`id`, `author_id`, `title`, `description`, `created`, `modified`) VALUES (1, 1, 'Web applications with CakePHP 3.4', '<p>In this presentation, the author is going to give a brief overview on how to create web applications using the CakePHP 3.4 framework.</p>\n<p>Key components of this presentation include:</p>\n<ul>\n<li>Introduction to MVC</li>\n<li>Convention over configuration</li>\n<li>Structure of CakePHP</li>\n<li>Best practices</li>\n</ul>', '2017-05-14 17:15:00', '2017-05-14 17:15:00');
